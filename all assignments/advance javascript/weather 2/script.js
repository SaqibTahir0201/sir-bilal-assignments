...
//# Default city name when page load

let cityInput = "London";

//# Add click event to each city in panel

cities.forEach((city) => {
  city.addEventListener("click", (e) => {
    cityInput = e.target.innerHTML;

    //# Function that fetches and displays all the data form the weather API
...
function fetchWeatherData() {
  fetch(
    `https://api.weatherapi.com/v1/current.json?key=c13e5fa6e0e64cb4a3e84615242306&q=${cityInput}`
  )
